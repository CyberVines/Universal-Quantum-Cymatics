...
#
# ./remote_rx.py  --address 192.168.188.21 --rate 500000 --freq=825500 > fillSDA1.raw
#
# Sample use with baudline:
# ./remote_rx.py  --address 192.168.188.21 --rate 500000 --freq=825500 | baudline -channels 2 -samplerate 20000 -stdin -quadrature -fftsize 65536 -reset -basefrequency 825500 -format le32f -scaleby 32767 -flipcomplex#
#
#
#
...
if __name__ == "__main__":
    ...
    parser.add_argument("--address", help="IP address Red Pitaya", default="108.248.74.131")
    parser.add_argument("--freq", help="Center Frequency, default 820000 Hz", type=int, default=825500)
    parser.add_argument("--rate", help="Sample rate, allowed values: 20000 50000 100000 250000 500000 1250000", type=int, default=20000)
