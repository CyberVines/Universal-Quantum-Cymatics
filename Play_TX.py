...
# Title: Play_TX
# Author: Justin Ried
# Generated: Sun May 22 05:33:35 2016
##################################################
...
class Play_TX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Play_TX")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Play_TX")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "Play_TX")
        ...
        self.osmosdr_sink_1.set_center_freq(462650000, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, "/root/Desktop/TXRX", False)
...
def main(top_block_cls=Play_TX, options=None):
